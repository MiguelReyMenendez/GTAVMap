...
$(function () {
  ...
  var assetsUrl = function () {
    return window.location.hostname == 'https://gtamap.onrender.com:3000'
	  //    return window.location.hostname == 'localhost' ? 'http://127.0.0.1:5500/gta5-map.github.io/' : 'https://gtamap.onrender.com:3000'
